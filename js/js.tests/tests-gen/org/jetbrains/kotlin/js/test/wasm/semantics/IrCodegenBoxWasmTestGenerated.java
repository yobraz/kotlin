...
public class IrCodegenBoxWasmTestGenerated extends AbstractIrCodegenBoxWasmTest {
    ...
    public static class Multicatch extends AbstractIrCodegenBoxWasmTest {
        ...
        public void testAllFilesPresentInMulticatch() throws Exception {
            KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/testData/codegen/box/multicatch"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.WASM, true);
        }
    }
