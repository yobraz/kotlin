...
class KaptIrTreeMaker(context: Context, kaptContext: KaptIrContextForStubGeneration) : TreeMaker(context), Disposable {
    ...
    companion object {
        internal fun preRegister(context: Context, kaptContext: KaptIrContextForStubGeneration) {
            context.put(treeMakerKey, Context.Factory<TreeMaker> { KaptIrTreeMaker(it, kaptContext) })
        }
    }
}
