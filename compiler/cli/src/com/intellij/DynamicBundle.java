...
public class DynamicBundle extends AbstractBundle {
    ...
    public static ResourceBundle getBundle(@NotNull String baseName, @NotNull Class<?> formClass) {
        ...
        return new ResourceBundle() {
            ...
            protected Object handleGetObject(@NotNull String key) {
                ...
                return appendLocalizationSuffix((String)get, L10N_MARKER);
            }
    ...
    private static @NotNull String appendLocalizationSuffix(@NotNull String result, @NotNull String suffixToAppend) {
