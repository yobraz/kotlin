...
object JvmRuntimeVersionsConsistencyChecker {
    ...
    private fun checkMatchingVersionsAndGetRuntimeVersion(
        ...
        val oldestVersion = jars.minByOrNull { it.version }!!.version
        val newestVersion = jars.minByOrNull { it.version }!!.version
        ...
        val maxStdlibJar =
            jars.filter { it.file.name.startsWith("kotlin-runtime")
                    || it.file.name.startsWith("kotlin-stdlib") }.maxByOrNull { it.version }
