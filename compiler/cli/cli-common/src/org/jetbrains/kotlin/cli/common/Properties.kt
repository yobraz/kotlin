...
enum class CompilerSystemProperties(val property: String, val alwaysDirectAccess: Boolean = false) {
    ...
    KOTLIN_STAT_ENABLED_PROPERTY("kotlin.stat.enabled"),
    KOTLIN_STAT_ELASTICSEARCH_HOST_PROPERTY("kotlin.stat.elasticsearch.host"),
    KOTLIN_STAT_ELASTICSEARCH_PORT_PROPERTY("kotlin.stat.elasticsearch.port"),
    KOTLIN_STAT_ELASTICSEARCH_INDEX_PROPERTY("kotlin.stat.elasticsearch.index"),
    KOTLIN_STAT_ELASTICSEARCH_USER_PROPERTY("kotlin.stat.elasticsearch.user"),
    KOTLIN_STAT_ELASTICSEARCH_PASSWORD_PROPERTY("kotlin.stat.elasticsearch.password"),
