...
fun foo(a: A) {
    val g : () -> Unit = {
        a.<!NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>gen<!>()  //it works: Unit is derived
    }

    val u: Unit = a.<!NEW_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>gen<!>() // Unit should be inferred
