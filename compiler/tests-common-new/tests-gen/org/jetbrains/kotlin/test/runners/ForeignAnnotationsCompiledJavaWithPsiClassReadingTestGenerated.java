        ...
        public class Jspecify {
            ...
            public class ModuleAnnotations {
                ...
                public class Strict {
                    ...
                    @Test
                    @TestMetadata("packageAnnotationAcrossSeveralModules.kt")
                    public void testPackageAnnotationAcrossSeveralModules() throws Exception {
                        runTest("compiler/testData/diagnostics/foreignAnnotationsTests/java9Tests/jspecify/moduleAnnotations/strict/packageAnnotationAcrossSeveralModules.kt");
                    }

                    @Test
                    @TestMetadata("packageAnnotationAcrossSeveralModulesWithoutEmptyPackageInfo.kt")
                    public void testPackageAnnotationAcrossSeveralModulesWithoutEmptyPackageInfo() throws Exception {
                        runTest("compiler/testData/diagnostics/foreignAnnotationsTests/java9Tests/jspecify/moduleAnnotations/strict/packageAnnotationAcrossSeveralModulesWithoutEmptyPackageInfo.kt");
                    }
                    ...
                    @Test
                    @TestMetadata("severalModulesSamePackage.kt")
                    public void testSeveralModulesSamePackage() throws Exception {
                        runTest("compiler/testData/diagnostics/foreignAnnotationsTests/java9Tests/jspecify/moduleAnnotations/strict/severalModulesSamePackage.kt");
                    }
                }
                ...
                public class Warn {
                    ...
                    @TestMetadata("packageAnnotationAcrossSeveralModules.kt")
                    public void testPackageAnnotationAcrossSeveralModules() throws Exception {
                        runTest("compiler/testData/diagnostics/foreignAnnotationsTests/java9Tests/jspecify/moduleAnnotations/warn/packageAnnotationAcrossSeveralModules.kt");
                    }

                    @Test
                    @TestMetadata("packageAnnotationAcrossSeveralModulesWithoutEmptyPackageInfo.kt")
                    public void testPackageAnnotationAcrossSeveralModulesWithoutEmptyPackageInfo() throws Exception {
                        runTest("compiler/testData/diagnostics/foreignAnnotationsTests/java9Tests/jspecify/moduleAnnotations/warn/packageAnnotationAcrossSeveralModulesWithoutEmptyPackageInfo.kt");
                    }
                    ...
                    @TestMetadata("severalModulesSamePackage.kt")
                    public void testSeveralModulesSamePackage() throws Exception {
                        runTest("compiler/testData/diagnostics/foreignAnnotationsTests/java9Tests/jspecify/moduleAnnotations/warn/severalModulesSamePackage.kt");
                    }
                }
            }
        }
