...
class RenderIrElementVisitor(private val normalizeNames: Boolean = false, private val stableOrder: Boolean = false) : IrElementVisitor<String, Nothing?> {
    ...
    private fun IrType.renderTypeInner() =
        when (this) {
            ...
            is IrErrorType -> "IrErrorType(${if (!stableOrder) originalKotlinType else null})"
