...
class IrInlineCodegen(
    ...
    override fun computeDefaultLambdaOffsets(): Map<Int, Boolean> {
        val parameterOffsets = parameterOffsets(function.isStatic, jvmSignature.valueParameters)
        val valueParameterOffset = if (function.extensionReceiverParameter != null) 1 else 0
        return function.valueParameters.filter { it.defaultValue != null && it.isInlineParameter() }.associate {
