    ...
    private fun handleInterface(irClass: IrClass) {
        ...
        for (function in irClass.functions) {
            when {
                ...
                isCompatibilityMode -> {
                    val visibility =
                        if (function.origin == IrDeclarationOrigin.FUNCTION_FOR_DEFAULT_PARAMETER) context.mapping.defaultArgumentsOriginalFunction[function]!!.visibility else function.visibility
