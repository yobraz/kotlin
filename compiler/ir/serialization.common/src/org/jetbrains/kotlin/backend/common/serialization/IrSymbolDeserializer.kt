...
//        assert(signature.isLocal)
    ...
    private fun deserializeFileLocalIdSignature(proto: ProtoFileLocalIdSignature): IdSignature.FileLocalSignature {
        val dbg = if (proto.hasDebugInfo()) fileReader.deserializeDebugInfo(proto.debugInfo) else null
        return IdSignature.FileLocalSignature(deserializeIdSignature(proto.container), proto.localId, dbg)
    }
