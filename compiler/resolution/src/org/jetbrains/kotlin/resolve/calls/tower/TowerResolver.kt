...
class TowerResolver {
    ...
    private inner class Task<out C : Candidate>(
        ...
        private fun ImplicitScopeTower.createNonLocalLevels(): Collection<ScopeTowerLevel> {
            ...
            parentScopes.drop(firstImportingScopeIndex).forEach(::addLevelForImportingScope)
        ...
        fun run(): Collection<C> {
            ...
            fun processScopes(
                ...
                for (scope in scopes) {
                    if (scope is LexicalScope) {
                    ...
                    } else if (!firstImportingScopePassed) {
                        ...
                        processImportingScope(scope as ImportingScope)
                    }
                }
                return null
            }
