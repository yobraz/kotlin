...
import org.jetbrains.kotlin.test.runners.ir.interpreter.AbstractIrPartialInterpreterTest
    ...
    generateTestGroupSuiteWithJUnit5(args) {
        testGroup(testsRoot = "compiler/tests-common-new/tests-gen", testDataRoot = "compiler/testData") {
            ...
            testClass<AbstractIrInterpreterAfterFir2IrTest> {
                model("ir/interpreter", excludeDirs = listOf("helpers", "partial"))
            }
            ...
            testClass<AbstractIrPartialInterpreterTest> {
                model("ir/interpreter/partial")
            }
        }
