...
public class FirDiagnosticsWithLightTreeTestGenerated extends AbstractFirDiagnosticsWithLightTreeTest {
    ...
    public class ResolveWithStdlib {
        ...
        public class Intellij {
            ...
            @Test
            @TestMetadata("ImproperLoopLabel.kt")
            public void testImproperLoopLabel() throws Exception {
                runTest("compiler/fir/analysis-tests/testData/resolveWithStdlib/intellij/ImproperLoopLabel.kt");
            }
