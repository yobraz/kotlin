...
@FixmeReflection
open class KProperty0Impl<out R>(override val name: String, val getter: KFunction0<R>): KProperty0<R> {
...
@FixmeReflection
open class KProperty1Impl<T, out R>(override val name: String, val getter: KFunction1<T, R>): KProperty1<T, R> {
    override val returnType get() = getter.returnType
...
@FixmeReflection
open class KProperty2Impl<T1, T2, out R>(override val name: String, val getter: KFunction2<T1, T2, R>): KProperty2<T1, T2, R> {
    override val returnType get() = getter.returnType
...
@FixmeReflection
class KMutableProperty0Impl<R>(name: String, getter: KFunction0<R>, val setter: (R) -> Unit)
...
@FixmeReflection
class KMutableProperty1Impl<T, R>(name: String, getter: KFunction1<T, R>, val setter: (T, R) -> Unit)
...
@FixmeReflection
class KMutableProperty2Impl<T1, T2, R>(name: String, getter: KFunction2<T1, T2, R>, val setter: (T1, T2, R) -> Unit)
