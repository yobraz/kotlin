...
extern testing::MockFunction<void(KRef)>* onUnhandledExceptionMock;
...
template<bool Strict = true>
ScopedMockFunction<void(KRef), Strict> ScopedOnUnhandledExceptionMock() {
    return ScopedMockFunction<void(KRef), Strict>(&internal::onUnhandledExceptionMock);
}
