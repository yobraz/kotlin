...
if (libclangextIsEnabled) {
    ...
    ldflags.addAll(listOf("-Wl,--no-demangle", "-Wl,-search_paths_first", "-Wl,-headerpad_max_install_names"))
    ldflags.addAll(undefinedSymbols.map { "-Wl,-U,$it" })
