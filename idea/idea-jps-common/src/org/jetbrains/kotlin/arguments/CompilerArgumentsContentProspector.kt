...
object CompilerArgumentsContentProspector {
    ...
    val freeArgsProperty: KProperty1<in CommonToolArguments, List<String>> by lazy { CommonToolArguments::freeArgs }
    val internalArgumentsProperty: KProperty1<in CommonToolArguments, List<InternalArgument>> by lazy { CommonToolArguments::internalArguments }
}