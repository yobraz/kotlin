...
fun devRepository(version: String) = RepositoryDescription(
    ...
    "https://teamcity.jetbrains.com/guestAuth/app/rest/builds/buildType:(id:Kotlin_KotlinPublic_Artifacts),number:$version,branch:(default:any)/artifacts/content/maven",
    null,
    isSnapshot = false
)
